...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/app.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4a384327", Component.options)
  } else {
    hotAPI.reload("data-v-4a384327", Component.options)
  }
})()}
...
exports = module.exports = new Vue();
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/404.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e587a284", Component.options)
  } else {
    hotAPI.reload("data-v-e587a284", Component.options)
  }
})()}
...
var ShopifyBuy = __webpack_require__(208);
...
var Ting = __webpack_require__(5);
var shopify = __webpack_require__(16);
var routes = {
  '/art': 'home.vue',
...
var app = new Vue({
  ...
  computed: {
    getView: function getView() {
      var view = routes[this.currentRoute];

      return view ? __webpack_require__(17)("./" + view) : __webpack_require__(15);
    }
  },
  created: function created() {
    var app = this;
    ...
    Object.keys(routes).forEach(function (route) {
      Page(route, function () {
        return app.currentPage = __webpack_require__(17)("./" + routes[route]);
      });
    });

    Page('*', function () {
      return app.currentPage = __webpack_require__(15);
    });
    Page();
  ...
  methods: {
    ...
    getProduct: function getProduct(id) {
      shopify.fetchProduct(id).then(function (product) {
        Ting.$emit('PRODUCT_FETCHED', product);
      });
    },
    getCart: function getCart() {
      shopify.fetchRecentCart().then(function (cart) {
        Ting.$emit('CART_FETCHED', cart);
      });
    }
  },
  render: function render(_render) {
    return _render(this.currentPage);
  }
});
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/show-item.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] show-item.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-525ec569", Component.options)
  } else {
    hotAPI.reload("data-v-525ec569", Component.options)
  }
})()}
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/art-item.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] art-item.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3d1aebb2", Component.options)
  } else {
    hotAPI.reload("data-v-3d1aebb2", Component.options)
  }
})()}
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/nav.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3eb5bdae", Component.options)
  } else {
    hotAPI.reload("data-v-3eb5bdae", Component.options)
  }
})()}
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/shop-item.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] shop-item.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b746a4e0", Component.options)
  } else {
    hotAPI.reload("data-v-b746a4e0", Component.options)
  }
})()}
...
const ArtNav = __webpack_require__(154);
const Ting = __webpack_require__(5);
...
module.exports = {
  props: ['image', 'title', 'description', 'update'],
  data() {
    return {
      styleObject: {
...
module.exports = {
  ...
  methods: {
    ...
    updateQuantity(event) {
      ...
      if (quantity > 0) {
        this.cart.updateLineItem(id, quantity).then(cart => {
          this.items = cart.lineItems;
          this.subtotal = cart.subtotal;
          this.cart = cart;
    ...
    removeItem(event) {
      ...
      this.cart.removeLineItem(id).then(cart => {
        this.items = cart.lineItems;
        this.subtotal = cart.subtotal;
        this.cart = cart;
...
const axios = __webpack_require__(7);
const App = __webpack_require__(3);
const ArtItem = __webpack_require__(153);
...
const App = __webpack_require__(3);
const ShowItem = __webpack_require__(36);
const Subscribe = __webpack_require__(157);
const Ting = __webpack_require__(5);
const axios = __webpack_require__(7);
...
const App = __webpack_require__(3);
const Ting = __webpack_require__(5);
const Share = __webpack_require__(155);
  ...
  methods: {
    ...
    addToCart(event) {
      ...
      Ting.$once('CART_FETCHED', cart => {
        ...
        if (this.isAvailable) {
          cart.createLineItemsFromVariants(variant).then(updatedCart => {
...
const App = __webpack_require__(3);
const ShopItem = __webpack_require__(156);
const Ting = __webpack_require__(5);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9), __webpack_require__(184).Buffer))
...
module.exports = "data:image/png;base64,"

/***/ }),
/* 211 */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),
/* 212 */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),
/* 213 */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),
/* 214 */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"

/***/ }),
/* 217 */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/cart.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8b8f26ec", Component.options)
  } else {
    hotAPI.reload("data-v-8b8f26ec", Component.options)
  }
})()}
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/contact.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-205daea6", Component.options)
  } else {
    hotAPI.reload("data-v-205daea6", Component.options)
  }
})()}
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/gallery.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c45bce50", Component.options)
  } else {
    hotAPI.reload("data-v-c45bce50", Component.options)
  }
})()}
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/product.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-75f55016", Component.options)
  } else {
    hotAPI.reload("data-v-75f55016", Component.options)
  }
})()}
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/shop.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b5801d40", Component.options)
  } else {
    hotAPI.reload("data-v-b5801d40", Component.options)
  }
})()}
...
Component.options.__file = "/Users/kreativemente/Websites/imkreative.com/src/art/show.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b4bad432", Component.options)
  } else {
    hotAPI.reload("data-v-b4bad432", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h1', [_vm._v("Contact Me")]), _vm._v(" "), _c('p', [_vm._v("For inquiries about purchasing original pieces and limited prints, or for information about shows, exhibitions, commissions, interviews and more, please contact me by filling out the form below.")]), _vm._v(" "), _c('div', {
    staticClass: "contact-page__form"
  }, [_c('form', {
    attrs: {
      "action": ""
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-205daea6", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "art-item__image-container",
    style: (_vm.styleObject)
  }, [_c('span', [_vm._v(_vm._s(_vm.title) + " / " + _vm._s(_vm.description))])]), _vm._v(" "), _c('div', {
    staticClass: "art-item__info"
  }, [_c('p', {
    staticClass: "art-item__title"
  }, [_vm._v(_vm._s(_vm.title))]), _vm._v(" "), _c('p', {
    staticClass: "art-item__desc"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3d1aebb2", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3eb5bdae", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.itemCount))])])])])]), _vm._v(" "), _vm._m(1)])
  ...
  return _c('footer', [_c('ul', [_c('li', {
    ...
    attrs: {
      "href": "http://www.instagram.com/kreativemente",
      "target": "_blank"
    }
    ...
    attrs: {
      "href": "http://www.facebook.com/artbymente",
      "target": "_blank"
    }
  }, [_vm._v("Facebook")])]), _vm._v(" "), _c('li', {
    staticClass: "twitter"
    ...
    attrs: {
      "href": "http://www.twitter.com/kreativemente",
      "target": "_blank"
    }
  }, [_vm._v("Twitter")])]), _vm._v(" "), _c('li', {
    staticClass: "youtube"
    ...
    attrs: {
      "href": "http://www.youtube.com/channel/UCrs5X_h4srCGAOWWN-QKNMA",
      "target": "_blank"
    }
  }, [_vm._v("Youtube")])])]), _vm._v(" "), _c('p', [_vm._v("Created by Clemente Gomez")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4a384327", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('p', [_c('span', [_vm._v(_vm._s(_vm.type) + " –")]), _vm._v(" " + _vm._s(_vm.getShowText) + "\n    "), (_vm.isUpcoming) ? [_vm._v(" — "), _c('a', {
    attrs: {
      "href": _vm.link,
      "target": "_blank"
    }
  }, [_vm._v("More Info")])] : _vm._e()], 2)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-525ec569", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('app', [_c('div', {
    ...
    staticClass: "product-page__product-name mobile"
  }, [_vm._v(_vm._s(_vm.productTitle))]), _vm._v(" "), _c('div', {
    staticClass: "product-page__image-container",
    class: {
      'sold-out': !_vm.isAvailable
    }
  }, [_c('img', {
    attrs: {
    ...
    staticClass: "product-page__product-info"
  }, [_c('h2', {
    staticClass: "product-page__product-name notmobile"
  }, [_vm._v(_vm._s(_vm.productTitle))]), _vm._v(" "), _c('p', {
    staticClass: "product-page__product-price"
  }, [_vm._v("$" + _vm._s(_vm.productPrice))]), _vm._v(" "), _c('div', {
    staticClass: "product-page__cart-container"
  }, [_c('form', {
    attrs: {
      "action": ""
    }
  }, [_c('div', {
    staticClass: "product-page__qty-container"
  }, [_c('label', {
    attrs: {
      "for": "productQuantity"
    }
  }, [_vm._v("Qty.")]), _vm._v(" "), _c('div', {
    staticClass: "product-page__input"
  }, [_c('input', {
    directives: [{
      name: "model",
    ...
    staticClass: "product-page__add-to-cart",
    on: {
      "click": _vm.addToCart
    }
  }, [_vm._v("Add to Cart")])])]), _vm._v(" "), _c('p', {
    staticClass: "product-page__product-desc"
  }, [_vm._v(_vm._s(_vm.productDesc))]), _vm._v(" "), _c('h3', {
  ...
  }, [_c('p', [_vm._v(_vm._s(_vm.addedAmount) + " " + _vm._s(_vm.addedProductTitle) + " added to your cart.")])])]), _vm._v(" "), _c('div', {
    staticClass: "sold-out-notification",
    class: {
      'show': _vm.soldOutNotificationShowing
    }
  }, [_c('p', [_vm._v("This item is sould out. Sorry =/")])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-75f55016", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('app', [_c('div', {
    staticClass: "cart"
  }, [_c('h2', [_vm._v("Shopping Cart")]), _vm._v(" "), (_vm.items.length > 0) ? [_c('ul', {
    staticClass: "cart__item-list"
  }, [_c('li', {
    staticClass: "cart__column-titles"
  }, [_c('p', {
    staticClass: "cart__column-item"
  }, [_vm._v("Item")]), _vm._v(" "), _c('p', {
    staticClass: "cart__column-title"
  }), _vm._v(" "), _c('p', {
    staticClass: "cart__column-qty"
  }, [_vm._v("Qty")]), _vm._v(" "), _c('p', {
    staticClass: "cart__column-price"
  }, [_vm._v("Price")]), _vm._v(" "), _c('p', {
    staticClass: "cart__column-close"
  })]), _vm._v(" "), _vm._l((_vm.items), function(item) {
    return _c('li', {
      staticClass: "cart__item"
    }, [_c('img', {
      staticClass: "cart__item-image",
      attrs: {
        "src": item.imageVariants[4].src,
        "alt": item.title
      }
    }), _vm._v(" "), _c('p', {
      staticClass: "cart__item-title"
    }, [_vm._v(_vm._s(item.title))]), _vm._v(" "), _c('div', {
      staticClass: "cart__qty-input"
    }, [_c('input', {
      attrs: {
        "type": "number",
        "data-id": item.id,
    ...
    }, [_vm._v("$" + _vm._s(item.line_price))]), _vm._v(" "), _c('button', {
      staticClass: "cart__close",
      attrs: {
        "data-id": item.id
      },
      on: {
    ...
    staticClass: "cart__subtotal"
  }, [_c('p', [_vm._v("Subtotal: $" + _vm._s(_vm.subtotal))])])], 2), _vm._v(" "), _c('button', {
    staticClass: "cart__checkout",
    on: {
      "click": _vm.checkout
    }
  }, [_vm._v("Checkout")])] : [_c('p', [_vm._v("You're Shopping Cart is empty. Head over to the "), _c('a', {
    attrs: {
      "href": "/art/shop"
    }
  }, [_vm._v("shop")]), _vm._v(" to start adding items to your cart.")])]], 2)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-8b8f26ec", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b4bad432", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h1', [_vm._v("Art Shop")]), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b5801d40", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: {
      'sold-out': !_vm.available
    },
    style: (_vm.styleObject)
  }, [_c('span', [_vm._v(_vm._s(_vm.title))]), _vm._v(" "), _c('a', {
    attrs: {
      "href": ("/art/shop/product/" + _vm.productID)
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "shop-item__product-info"
  }, [_c('p', {
    staticClass: "shop-item__product-name"
  }, [_vm._v(_vm._s(_vm.title))]), _vm._v(" "), _c('p', {
    staticClass: "shop-item__product-price"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b746a4e0", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-c45bce50", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('app', [_c('h1', [_vm._v("Error")])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-e587a284", module.exports)
  }
}
